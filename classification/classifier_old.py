...
training_data = [{"class": "greeting", "sentence": "how are you?"},
                 ...
                 {"class": "greeting", "sentence": "hi there"},
                 ...
                 {"class": "goodbye", "sentence": "bye bye"},
                 {"class": "goodbye", "sentence": "I am gone"},
                 {"class": "goodbye", "sentence": "talk to you soon"},
                 {"class": "sandwich", "sentence": "give me a sandwich"},
                 {"class": "sandwich", "sentence": "can you make a sandwich?"},
                 {"class": "sandwich", "sentence": "having a sandwich today?"},
                 {"class": "sandwich", "sentence": "i am hungry"},
...
def do_training(_x=training, _y=output, show_details=True):
    X = np.array(_x)
    y = np.array(_y)

    start_time = time.time()
    train(X, y, hidden_neurons=20, alpha=0.2, epochs=100000, dropout=False, dropout_percent=0.2)
